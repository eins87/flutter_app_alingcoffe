import '../checkout_selected_schedule_screen/widgets/listassoonasposs_item_widget.dart';
import 'controller/checkout_selected_schedule_controller.dart';
import 'models/listassoonasposs_item_model.dart';
...
class CheckoutSelectedScheduleScreen
    extends GetWidget<CheckoutSelectedScheduleController> {
  @override
                                              ...
                                              child: Obx(() =>
                                                  ListView.separated(
                                                      ...
                                                      itemCount: controller
                                                          .checkoutSelectedScheduleModelObj
                                                          .value
                                                          .listassoonaspossItemList
                                                          .length,
                                                      itemBuilder:
                                                          (context, index) {
                                                        ListassoonaspossItemModel
                                                            model = controller
                                                                .checkoutSelectedScheduleModelObj
                                                                .value
                                                                .listassoonaspossItemList[index];
                                                        return ListassoonaspossItemWidget(
                                                            model);
                                                      }))),
                                          Container(
