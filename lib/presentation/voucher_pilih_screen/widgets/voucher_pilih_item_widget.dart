...
class VoucherPilihItemWidget extends StatelessWidget {
  VoucherPilihItemWidget(this.voucherPilihItemModelObj);

  VoucherPilihItemModel voucherPilihItemModelObj;

  var controller = Get.find<VoucherPilihController>();
