...
class Listassoonasposs1ItemWidget extends StatelessWidget {
  Listassoonasposs1ItemWidget(this.listassoonasposs1ItemModelObj);

  Listassoonasposs1ItemModel listassoonasposs1ItemModelObj;

  var controller = Get.find<CheckoutSelectedVoucherController>();
