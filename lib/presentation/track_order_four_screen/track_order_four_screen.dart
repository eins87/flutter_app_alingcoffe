...
class TrackOrderFourScreen extends GetWidget<TrackOrderFourController> {
  @override
                                    ...
                                    Padding(
                                        ...
                                        child: Text("lbl_receipt_order".tr,
                                            ...
                                            style: AppStyle
                                                ...
                                                .copyWith(height: 1.00))),
                                    Padding(
                                        padding: getPadding(left: 4, bottom: 3),
                                        child: CommonImageView(
                                            svgPath: ImageConstant
                          ...
                          child: Column(
                              ...
                              children: [
                                ...
                                CustomButton(
                                    ...
                                    onTap: onTapBtnTakeorder),
                                Align(
                                    alignment: Alignment.center,
                                    child: Container(
                                        width: getHorizontalSize(184.00),
                                        margin: getMargin(
                                            left: 74, top: 12, right: 74),
                                        child: Text("msg_take_order_when".tr,
                                            maxLines: null,
