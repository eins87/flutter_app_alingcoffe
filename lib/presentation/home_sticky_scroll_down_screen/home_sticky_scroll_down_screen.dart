import '../home_sticky_scroll_down_screen/widgets/listellipsetwentysix_item_widget.dart';
...
class HomeStickyScrollDownScreen
    extends GetWidget<HomeStickyScrollDownController> {
  @override
                ...
                child: Column(
                                                        ...
                                                        child: Row(
                                                            ...
                                                            children: [
                                                              GestureDetector(
                                                                  ...
                                                                  child: Container(
                                                                      decoration: AppDecoration.fillGray200.copyWith(borderRadius: BorderRadiusStyle.roundedBorder12),
                  ...
                  Padding(
                      ...
                      child: Obx(() => ListView.builder(
                          ...
                          shrinkWrap: true,
                          itemCount: controller.homeStickyScrollDownModelObj
                              .value.listellipsetwentysixItemList.length,
                          itemBuilder: (context, index) {
                            ListellipsetwentysixItemModel model = controller
                                .homeStickyScrollDownModelObj
                                .value
                                .listellipsetwentysixItemList[index];
                            return ListellipsetwentysixItemWidget(model,
