...
class Listellipsetwentysix2ItemWidget extends StatelessWidget {
  Listellipsetwentysix2ItemWidget(this.listellipsetwentysix2ItemModelObj,
      {this.onTapCardproduk});

  Listellipsetwentysix2ItemModel listellipsetwentysix2ItemModelObj;

  var controller = Get.find<HomeFilterRatingController>();
