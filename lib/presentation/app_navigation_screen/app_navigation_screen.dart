...
class AppNavigationScreen extends GetWidget<AppNavigationController> {
  ...
  Widget build(BuildContext context) {
    return SafeArea(
        child: Scaffold(
            backgroundColor: ColorConstant.whiteA703,
            body: Column(
                ...
                children: [
                  Container(
                      width: size.width,
                      decoration: AppDecoration.fillWhiteA703,
                      child: Column(
                          mainAxisSize: MainAxisSize.min,
                          mainAxisAlignment: MainAxisAlignment.start,
                          children: [
                              ...
                              child: Container(
                                  ...
                                  child: Column(
                                      ...
                                      children: [
                                        ...
                                        GestureDetector(
                                            onTap: () {
                                              onTapHOMEaddorderstickyscrolldown();
                                            },
                                            child: Container(
                                                width: size.width,
                                                decoration:
  ...
  onTapRegisterOne() {
    Get.toNamed(AppRoutes.registerOneScreen);
  }

  onTapRegisterSix() {
    Get.toNamed(AppRoutes.registerSixScreen);
  }

  onTapRegisterFour() {
    Get.toNamed(AppRoutes.registerFourScreen);
  }

  onTapRegisterThree() {
    Get.toNamed(AppRoutes.registerThreeScreen);
  }

  onTapRegisterTwo() {
    Get.toNamed(AppRoutes.registerTwoScreen);
  }
  ...
  onTapCreateaPINOne() {
    Get.toNamed(AppRoutes.createAPinOneScreen);
  }

  onTapCreateaPIN() {
    Get.toNamed(AppRoutes.createAPinScreen);
  }
  ...
  onTapKonfirmkodeotpThree() {
    Get.toNamed(AppRoutes.konfirmKodeOtpThreeScreen);
  }

  onTapKonfirmkodeotpTwo() {
    Get.toNamed(AppRoutes.konfirmKodeOtpTwoScreen);
  }

  onTapKonfirmkodeotp() {
    Get.toNamed(AppRoutes.konfirmKodeOtpScreen);
  }
  ...
  onTapFrame2093() {
    Get.toNamed(AppRoutes.frame2093Screen);
  }
  ...
  onTapLoginTwoOne() {
    Get.toNamed(AppRoutes.logintwoOneScreen);
  }
  ...
  onTapLoginTwoTwo() {
    Get.toNamed(AppRoutes.logintwoTwoScreen);
  }
  ...
  onTapKonfirmkodeotpOne() {
    Get.toNamed(AppRoutes.konfirmKodeOtpOneScreen);
  }

  onTapKonfirmkodeotpFour() {
    Get.toNamed(AppRoutes.konfirmKodeOtpFourScreen);
  }
  ...
  onTapHOMEfilterratingOne() {
    Get.toNamed(AppRoutes.homeFilterRatingOneScreen);
  }

  onTapHOMEfilterrating() {
    Get.toNamed(AppRoutes.homeFilterRatingScreen);
  }
  ...
  onTapHOMEaddorderstickyscrolldown() {
    Get.toNamed(AppRoutes.homeAddOrderStickyScrollDownScreen);
  }
  ...
  onTapChooseapickuptime() {
    Get.toNamed(AppRoutes.chooseAPickUpTimeScreen);
  }
  ...
  onTapCheckoutselectedvoucher() {
    Get.toNamed(AppRoutes.checkoutSelectedVoucherScreen);
  }

  onTapLoadingcheckout() {
    Get.toNamed(AppRoutes.loadingCheckoutScreen);
  }

  onTapTransactionsuccess() {
    Get.toNamed(AppRoutes.transactionSuccessScreen);
  }
  ...
  onTapTrackorderFour() {
    Get.toNamed(AppRoutes.trackOrderFourScreen);
  }

  onTapPopupOne() {
    Get.toNamed(AppRoutes.popUpOneScreen);
  }

  onTapRatingReview() {
    Get.toNamed(AppRoutes.ratingReviewScreen);
  }

  onTapRatingandreview() {
    Get.toNamed(AppRoutes.ratingAndReviewScreen);
  }
  ...
  onTapMetodePembayaranExpanded() {
    Get.toNamed(AppRoutes.metodePembayaranExpandedScreen);
  }
